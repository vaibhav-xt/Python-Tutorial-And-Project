...
# Object Introspection - it is a detail of class that is type, object all about that.

skill = Employee("skill", "F")
print(skill.email)

print(dir(skill))  # in result you get all about the detail that you can it with string.
print(id("this is a book"))
